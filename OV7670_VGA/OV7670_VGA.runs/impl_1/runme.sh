...
HD_PWD='C:/Users/idowe/Projects/Digital-Zoom-FPGA/OV7670_VGA/OV7670_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BILINEAR_INTERPOLATION_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BILINEAR_INTERPOLATION_TOP.tcl -notrace
