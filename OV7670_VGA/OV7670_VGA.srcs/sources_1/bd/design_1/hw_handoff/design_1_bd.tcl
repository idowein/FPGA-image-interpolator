...
# module references:
# OV7670_capture, cntl, ov7670_controller, vga
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net OV7670_capture_0_addr [get_bd_pins OV7670_capture_0/addr] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net OV7670_capture_0_dout [get_bd_pins OV7670_capture_0/dout] [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net OV7670_capture_0_wr_en [get_bd_pins OV7670_capture_0/wr_en] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins vga_0/frame_fix]
  connect_bd_net -net camera_h_ref_1 [get_bd_ports camera_h_ref] [get_bd_pins OV7670_capture_0/camera_v_sync]
  connect_bd_net -net camera_v_sync_1 [get_bd_ports camera_v_sync] [get_bd_pins OV7670_capture_0/camera_h_ref]
  ...
  connect_bd_net -net din_1 [get_bd_ports din] [get_bd_pins OV7670_capture_0/din]
  ...
  connect_bd_net -net pclk_0_1 [get_bd_ports pclk] [get_bd_pins OV7670_capture_0/pclk] [get_bd_pins blk_mem_gen_0/clka]
  ...
  connect_bd_net -net zoom_x2_0_1 [get_bd_ports zoom_x2] [get_bd_pins OV7670_capture_0/zoom_x2] [get_bd_pins vga_0/zoom_x2]
