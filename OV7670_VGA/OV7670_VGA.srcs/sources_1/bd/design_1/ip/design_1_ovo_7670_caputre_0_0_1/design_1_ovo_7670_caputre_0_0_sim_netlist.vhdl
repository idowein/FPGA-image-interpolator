...
architecture STRUCTURE of design_1_ovo_7670_caputre_0_0_ovo_7670_caputre is
  ...
  signal \address[18]_i_10_n_0\ : STD_LOGIC;
  signal \address[18]_i_11_n_0\ : STD_LOGIC;
  signal \address[18]_i_12_n_0\ : STD_LOGIC;
  signal \address[18]_i_13_n_0\ : STD_LOGIC;
  ...
  signal \counter_col[9]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \counter_row[10]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \address[18]_i_10\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \address[18]_i_13\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \address[18]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \address[18]_i_6\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \address[18]_i_7\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter_col[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \counter_col[10]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \counter_col[10]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter_col[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \counter_col[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_col[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_col[4]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \counter_col[9]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter_row[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter_row[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter_row[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter_row[4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter_row[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \counter_row[7]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \counter_row[8]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter_row[9]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of wr_en_i_3 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of wr_en_i_4 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \write_state[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \write_state[1]_i_1\ : label is "soft_lutpair11";
begin
  addr(18 downto 0) <= \^addr\(18 downto 0);
  wr_en <= \^wr_en\;
\address[18]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F1F1F11100000000"
    )
        port map (
      I0 => zoom_x2,
      I1 => zoom_x4,
...
\address[18]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
      ...
      O => \address[18]_i_10_n_0\
    );
\address[18]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3626666626666666"
    )
        port map (
      ...
      I4 => counter_row_reg(5),
      I5 => counter_row_reg(4),
      O => \address[18]_i_11_n_0\
    );
\address[18]_i_12\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => counter_row_reg(2),
      O => \address[18]_i_12_n_0\
    );
\address[18]_i_13\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      ...
      O => \address[18]_i_13_n_0\
    );
\address[18]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\address[18]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFEAAFC00FC00"
        ...
        port map (
      I0 => \address[18]_i_6_n_0\,
      I1 => \address[18]_i_7_n_0\,
      I2 => \address[18]_i_8_n_0\,
      I3 => \address[18]_i_9_n_0\,
      I4 => \address[18]_i_10_n_0\,
      I5 => \address[18]_i_11_n_0\,
...
\address[18]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAABA00000000"
        ...
        port map (
      I0 => \address[18]_i_12_n_0\,
      I1 => counter_row_reg(4),
      I2 => \address[18]_i_13_n_0\,
      I3 => counter_row_reg(6),
      I4 => counter_row_reg(2),
      I5 => \address[18]_i_9_n_0\,
      O => \address[18]_i_5_n_0\
    );
\address[18]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7AAA0000"
    )
        port map (
...
\address[18]_i_8\: unisim.vcomponents.LUT6
    generic map(
...
\address[18]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0180FF00"
    )
        port map (
      I0 => counter_col_reg(5),
      I1 => counter_col_reg(4),
      I2 => counter_col_reg(6),
      I3 => counter_col_reg(8),
      I4 => counter_col_reg(7),
...
\counter_col[10]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
      ...
      I2 => counter_col_reg(10),
      O => \plusOp__0\(10)
    );
\counter_col[10]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7FFFFFF"
    )
        port map (
...
\counter_col[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
wr_en_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A8"
    )
        port map (
