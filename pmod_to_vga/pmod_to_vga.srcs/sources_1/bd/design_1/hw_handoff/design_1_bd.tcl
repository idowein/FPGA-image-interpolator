...
# module references:
# cntl, ov7670_controller, ovo_7670_caputre, vga_02, xlconstant_0
...
proc create_root_design { parentCell } {
  ...
  # Create instance: vga_02_0, and set properties
  set block_name vga_02
  set block_cell_name vga_02_0
  if { [catch {set vga_02_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $vga_02_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  set block_name xlconstant_0
  set block_cell_name xlconstant_0_0
  if { [catch {set xlconstant_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $xlconstant_0_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net Net [get_bd_pins ovo_7670_caputre_0/zoom] [get_bd_pins vga_02_0/zoom]
  connect_bd_net -net Net1 [get_bd_ports siod] [get_bd_pins ov7670_controller_0/siod]
  connect_bd_net -net Net2 [get_bd_pins clk_wiz_1/reset] [get_bd_pins xlconstant_0_0/din]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins vga_02_0/frame_fix]
  ...
  connect_bd_net -net clk_in1_0_1 [get_bd_ports clk_in1] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins cntl_0/clk]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins ov7670_controller_0/clk] [get_bd_pins vga_02_0/pix_clk]
  connect_bd_net -net cntl_0_cntl_out [get_bd_pins cntl_0/cntl_out] [get_bd_pins vga_02_0/cntl]
  ...
  connect_bd_net -net vga_02_0_frame_adress [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins vga_02_0/frame_adress]
