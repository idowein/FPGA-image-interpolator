...
HD_PWD='C:/Users/idowe/myProjects/FPGA-image-interpolator/nandland/VGA/VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_DISPLAY_UNIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_DISPLAY_UNIT.tcl -notrace
