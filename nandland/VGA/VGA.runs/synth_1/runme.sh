...
HD_PWD='C:/Users/idowe/myProjects/FPGA-image-interpolator/nandland/VGA/VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_DISPLAY_UNIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_DISPLAY_UNIT.tcl
