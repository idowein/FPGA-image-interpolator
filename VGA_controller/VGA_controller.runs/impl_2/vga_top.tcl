...
set rc [catch {
  ...
  add_files -quiet C:/Users/idowe/myProjects/FPGA-image-interpolator/VGA_controller/VGA_controller.runs/synth_2/vga_top.dcp
...
set rc [catch {
  ...
  create_report "impl_2_place_report_control_sets_0" "report_control_sets -verbose -file vga_top_control_sets_placed.rpt"
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force vga_top_physopt.dcp
...
set rc [catch {
  ...
  create_report "impl_2_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file vga_top_timing_summary_routed.rpt -pb vga_top_timing_summary_routed.pb -rpx vga_top_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_2_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file vga_top_bus_skew_routed.rpt -pb vga_top_bus_skew_routed.pb -rpx vga_top_bus_skew_routed.rpx"
