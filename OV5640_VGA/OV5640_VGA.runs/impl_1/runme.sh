...
HD_PWD='C:/Users/idowe/myProjects/FPGA-image-interpolator/OV5640_VGA/OV5640_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ov5640_controller.tcl -notrace
