...
HD_PWD='C:/Users/idowe/myProjects/FPGA-image-interpolator/OV5640_VGA/OV5640_VGA.runs/frame_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frame_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frame_buffer.tcl
