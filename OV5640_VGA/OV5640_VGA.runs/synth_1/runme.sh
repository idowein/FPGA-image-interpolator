...
HD_PWD='C:/Users/idowe/myProjects/FPGA-image-interpolator/OV5640_VGA/OV5640_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ov5640_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ov5640_controller.tcl
