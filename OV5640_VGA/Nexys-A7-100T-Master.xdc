...
set_property PULLDOWN true [get_ports pwdn]                 # Add pulldown to prevent floating

set_property PACKAGE_PIN F6 [get_ports reset]            #JC[2] - not connected!
set_property IOSTANDARD LVCMOS33 [get_ports reset]
set_property PULLDOWN true [get_ports reset]             # Add pulldown to prevent floating

set_property PACKAGE_PIN J2 [get_ports pclk]            #JC[3]
set_property IOSTANDARD LVCMOS33 [get_ports pclk]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pclk]  # Only required if pclk is not on a clock-dedicated pin
