...
HD_PWD='C:/Users/idowe/myProjects/FPGA-image-interpolator/NIR_PROJECT/NIR_PROJECT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DIGITAL_CLOCK_NEW2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DIGITAL_CLOCK_NEW2.tcl -notrace
