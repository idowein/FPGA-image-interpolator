...
HD_PWD='C:/Users/idowe/myProjects/FPGA-image-interpolator/NIR_PROJECT/NIR_PROJECT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DIGITAL_CLOCK_NEW2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DIGITAL_CLOCK_NEW2.tcl
